...
/******************************************************************************/
/*  Source  File :                DK_Serbian.c                                */
/******************************************************************************/
/*                                                                            */
/*                Unit Local Serbian Language Strings                         */
/*                                                                            */
/*                                                                            */
/*  Author : Nebojsa Jakovljevic                   Date : 12-08-2015          */
/*                                                                            */
/******************************************************************************/
...
#ifndef __DK_SERBIAN_C
#define __DK_SERBIAN_C

/*********************************************************************
 Function:          Serbian Ascii Strings
 ...
 Author/Date:   Nebojsa Jakovljevic / 2015.08.12 09:09 
...
LocalStringTables LS __attribute__((at(LOCSTRINGSBASEADDRESS)))={
  ...
  "    NE KORISTI SE    ",  //  3
  "    GAŠENJE MOTORA   ",  //  4
  "ALARM PROPADA NAPONA ",  //  5
  "      UPOZORENJE     ",  //  6

  " PARAMETRI AGREGATA  ",  //  7
  " GEN NAPON PO FAZI   ",  //  8
  "GEN   Amps      Hz   ",  //  9
  "GEN   kW        Pf   ",  //  10
  "GEN   kVA      kVAr  ",  //  11
  "GEN SREDNJE VREDNOSTI",  //  12
  "  GEN PHASE  Lx CURR ",  //  13
  " GEN NEUTRALNA STRUJA",  //  14
  "  AKTIVNA SNAGA GEN  ",  //  15
  " REAKTIVNA SNAGA GEN ",  //  16
  "   FAKTOR SNAGE GEN  ",  //  17
  "   FREKVENCIJA GEN   ",  //  18
  ...
  "  PARAMETRI MOTORA   ",  //  20
  "    PRITISAK ULJA    ",  //  21
  "  TEMPERATURA MOTORA ",  //  22
  "     NIVO GORIVA     ",  //  23
  "   TEMPERATURA ULJA  ",  //  24
  " TEMPERATURA KUĆIŠTA ",  //  25
  " TEMPERATURA OKOLINE ",  //  26
  "    BRZINA MOTORA    ",  //  27
  "    NAPON BATERIJE   ",  //  28
  "  RADNI SATI MOTORA  ",  //  29
  "Broj startova:       ",  //  30
               
  "   PARAMETRI MREŽE   ",  //  31
  "MREŽNI NAPON PO FAZI ",  //  32
  "MREŽA Amps      Hz   ",  //  33
  "MREŽA  kW       Pf   ",  //  34
  "MREŽA kVA      kVAr  ",  //  35
  "SREDNJE VREDNO. MREŽE",  //  36
  " MAINS PHASE Lx CURR ",  //  37
  "NEUTRAL. STRUJA MREŽE",  //  38
  " AKTIVNA SNAGA MREŽE ",  //  39
  "REAKTIVNA SNAGA MREŽE",  //  40
  " FAKTOR SNAGE MREŽE  ",  //  41
  "  FREKVENCIJA MREŽE  ",  //  42
...
#endif //EOF __DK_SERBIAN_C
/****************************************************************************
**                            End Of DK_Serbian.c File
****************************************************************************/
